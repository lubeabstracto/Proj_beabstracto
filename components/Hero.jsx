              ...
              <div className={`relative px-6 py-32 sm:py-40 lg:px-8 lg:pr-0 sm:pr-6 ${isMobile ? 'sm:pl-6' : ''}`}>
                <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-4xl">
                  <div className="hidden sm:mb-10 sm:flex">
                    <div className="font-brand relative rounded-full px-3 py-1 text-body-4 font-body-4 leading-6 text-gray-500 bg-white ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                      ...
                      <a href="#" className="whitespace-nowrap font-semibold text-semantic-tertiary-default">
                        <span className="font-brand absolute inset-0" aria-hidden="true" />
                  ...
                  <p className="font-brand mt-6 text-xl leading-8 text-gray-900">
